...
if (!command) {
  console.log('使用方法:');
  console.log('  node scripts/version.js patch    - 递增修订号 (1.0.0 -> 1.0.1)');
  console.log('  node scripts/version.js minor    - 递增次版本号 (1.0.0 -> 1.1.0)');
  console.log('  node scripts/version.js major    - 递增主版本号 (1.0.0 -> 2.0.0)');
  console.log('  node scripts/version.js alpha    - 创建alpha预发布版本');
  console.log('  node scripts/version.js beta     - 创建beta预发布版本');
  console.log('  node scripts/version.js rc       - 创建rc预发布版本');
  console.log('  node scripts/version.js show     - 显示当前版本号');
  process.exit(0);
}
